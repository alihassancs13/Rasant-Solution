...
urlpatterns = [
    ...
    # ---------- Salaries / Increment Policies ----------
    # NOTE: no 'api/' prefix here — the root urls.py already mounts this
    # whole file under 'api/employeeDashboard/', same as every other route
    # above (add_employee/, get_employees/, job-openings/, etc.)
