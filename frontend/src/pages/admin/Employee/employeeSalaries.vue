          ...
          <div class="flex items-start justify-between gap-4 flex-wrap p-4 sm:p-5">
            <div>
              ...
              <p class="text-sm text-text-muted mt-0.5 max-w-2xl">
                Review compensation, assigned policies, and projected salaries. Rows highlighted in amber have an
                increment due today or overdue.
              </p>
            </div>
          ...
          <div class="overflow-x-auto">
            <table class="w-full text-sm">
              ...
              <tr class="border-t border-border-subtle">
                <th class="text-left px-4 sm:px-5 py-3 text-[11px] font-semibold text-text-muted tracking-wide uppercase">
                  Employee
                </th>
                <th class="text-left px-4 sm:px-5 py-3 text-[11px] font-semibold text-text-muted tracking-wide uppercase">
                  Salary
              ...
              >
                ...
                <td class="px-4 sm:px-5 py-4 font-semibold text-text-primary whitespace-nowrap">
              ...
              <div class="p-4 sm:p-5 flex-1">
                ...
                <div class="flex items-center gap-2 mt-3 pt-3 border-t border-border-subtle">
                  <button
                      ...
                      :disabled="isTogglingActive === policy.id"
                      class="relative inline-flex h-5 w-9 items-center rounded-full transition-colors shrink-0 disabled:opacity-50 disabled:cursor-not-allowed"
                      :class="policy.is_active ? 'bg-emerald-500' : 'bg-gray-300'"
                  >
                    <span
                        class="inline-block h-3.5 w-3.5 transform rounded-full bg-white transition-transform"
                        :class="policy.is_active ? 'translate-x-4.5' : 'translate-x-0.5'"
                    />
                  </button>

                  <span v-if="!policy.is_active" class="text-sm text-warning font-semibold">Inactive</span>
                  <span v-else class="text-sm text-text-muted">Active</span>
                </div>
              </div>
