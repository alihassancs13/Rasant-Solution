<template>
  ...
  <div class="bg-white w-full max-w-4xl rounded-xl shadow-xl relative border border-slate-200 mx-auto max-h-[95vh] flex flex-col overflow-hidden">
    ...
    <div class="p-4 px-6 border-b border-slate-100 bg-white relative shrink-0">
      <!-- Pinned Close Button inside Header Context -->
      <button type="button" class="absolute top-4 right-6 text-slate-400 hover:text-slate-600 transition z-50" @click="close">
    ...
    <div class="p-6 border-t border-slate-100 bg-slate-50/80 flex justify-between items-center shrink-0">
      ...
      <div class="flex gap-3">
        <!-- Added a proper Modal Close button into the fixed footer context -->
        <button type="button" @click="close" class="px-5 py-2.5 rounded-xl border border-slate-200 text-slate-600 font-semibold text-sm hover:bg-slate-100 transition bg-white">
          Close
        </button>
