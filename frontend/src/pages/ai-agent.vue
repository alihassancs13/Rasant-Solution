      ...
      <div class="relative max-w-[1040px] mx-auto px-6 z-30 grid grid-cols-1 md:grid-cols-2 gap-8 items-center pt-8 pb-12">
        ...
        <div class="relative z-30 text-left max-w-[560px] mx-auto md:mx-0 mt-15">
          ...
          <h1 class="font-display text-[clamp(28px,4vw,44px)] font-bold tracking-[-1px] leading-[1.15] mb-4 text-primary-900">
            Talking agents with <em class="not-italic bg-gradient-to-r from-accent-1 to-accent-3 bg-clip-text text-transparent">clear, natural voice</em>
          </h1>
    ...
    <section class="relative py-18 px-[5%] overflow-hidden" id="flow">
      <div class="relative max-w-285 mx-auto grid grid-cols-1 md:grid-cols-[0.88fr_1.12fr] gap-[clamp(28px,5vw,56px)] items-center">
        ...
        <div class="relative z-20">
          ...
          <h2 class="font-display text-[clamp(24px,3vw,36px)] font-bold tracking-[-0.8px] leading-[1.15] text-primary-900 my-2 relative z-10">From ring to resolution on the phone</h2>
          <p class="text-[15px] text-neutral-600 leading-relaxed max-w-115 font-primary">Route every call through speech recognition, intent handling, and smart transfer — so callers get answers on the line without waiting in silence.</p>
        </div>

        <div class="relative z-10 flex items-center justify-center bg-white rounded-2xl shadow-2xl shadow-primary-600/20">
    ...
    <section class="relative py-18 px-[5%] overflow-hidden bg-neutral-100" id="dashboard">
      <div class="relative max-w-285 mx-auto grid grid-cols-1 md:grid-cols-[1.12fr_0.88fr] gap-[clamp(28px,5vw,56px)] items-center">
        ...
        <div class="relative z-10 flex items-center justify-center order-last md:order-first">
          <div class="relative w-full max-w-140 mx-auto">
            ...
            <div
                ...
                :style="parallaxStyle"
                class="relative z-10 w-full mx-auto p-4.5 rounded-[18px] bg-white/92 border border-neutral-300/80 shadow-[0_20px_52px_rgba(15,23,42,0.09)] transition-all duration-350 ease-out animate-[aaVisualFloat_7s_ease-in-out_infinite]"
            >
              <div class="relative z-10 grid grid-cols-1 gap-2.5">
                <div class="bg-neutral-50 border border-neutral-300/60 rounded-[14px] p-[10px_10px_8px] animate-[aaTileFloat_5s_ease-in-out_infinite] transition-all hover:border-accent-1/40 hover:shadow-md">
                  <span class="block text-[9px] font-bold tracking-wider uppercase text-neutral-500 mb-2 pl-0.5 font-display">Scheduled queue</span>
                  <div class="overflow-hidden rounded-[10px] bg-white border border-neutral-100 h-[170px] md:h-[108px]">
                    <img src="../assets/svg/ai-agent-scheduled-calls.svg" alt="Scheduled calls overview" class="w-full block -mt-1.5" />
                  </div>
                </div>

                <div class="bg-neutral-50 border border-neutral-300/60 rounded-[14px] p-[10px_10px_8px] animate-[aaTileFloat_5s_ease-in-out_infinite] [animation-delay:0.8s] transition-all hover:border-accent-1/40 hover:shadow-md">
                  <span class="block text-[9px] font-bold tracking-wider uppercase text-neutral-500 mb-2 pl-0.5 font-display">Activity and usage</span>
                  <div class="grid grid-cols-1 sm:grid-cols-[0.42fr_0.58fr] gap-2">
                    <div class="overflow-hidden rounded-[10px] bg-white border border-neutral-100 h-[150px] md:h-[108px]">
                      <img src="../assets/svg/ai-agent-analytics.svg" alt="Analytics summary" class="w-full block" />
                    </div>
                    <div class="overflow-hidden rounded-[10px] bg-neutral-50 border border-neutral-100 h-[150px] md:h-[108px] flex items-center justify-center">
        ...
        <div class="relative z-20">
          ...
          <h2 class="font-display text-[clamp(24px,3vw,36px)] font-bold tracking-[-0.8px] leading-[1.15] text-primary-900 my-2 relative z-10">Monitor every call in real time</h2>
          <p class="text-[15px] text-neutral-600 leading-relaxed max-w-115 font-primary">See queues, live volume, and agent activity in one glance — from scheduled callbacks to activity trends.</p>
          ...
          <div class="flex flex-wrap items-center gap-2.5 mt-4.5">
            ...
            <div class="flex flex-wrap gap-1.5">
              <span v-for="(stat, i) in liveStats" :key="i"
                    class="text-[11px] text-neutral-500 px-3 py-1.5 rounded-full bg-neutral-100 border border-neutral-300/60 animate-[aaChipPop_0.55s_cubic-bezier(0.22,1,0.36,1)_both] font-primary"
        ...
        <div class="relative max-w-285 mx-auto grid grid-cols-1 md:grid-cols-[0.88fr_1.12fr] gap-[clamp(28px,5vw,56px)] items-center mb-7">
          ...
          <div class="relative z-20">
            ...
            <h2 class="font-display text-[clamp(24px,3vw,36px)] font-bold tracking-[-0.8px] leading-[1.15] text-primary-900 my-2 relative z-10">
              Built for real calls. <em class="not-italic bg-gradient-to-r from-accent-1 to-accent-3 bg-clip-text text-transparent">Operator-grade control.</em>
            </h2>
            <p class="text-[15px] text-neutral-600 leading-relaxed max-w-115 font-primary">Customer lines, internal dialing, and outbound campaigns — with clear speech, live queues, and smart routing in one voice stack.</p>
          </div>
      ...
      <div class="relative max-w-285 mx-auto grid grid-cols-1 md:grid-cols-[1.12fr_0.88fr] gap-[clamp(28px,5vw,56px)] items-center">
        ...
        <div class="relative z-10 flex items-center justify-center order-last md:order-first">
          <div class="relative w-full max-w-140 mx-auto animate-[aaVisualFloat_6s_ease-in-out_infinite]">
            ...
            <div class="relative z-10 rounded-2xl overflow-hidden border border-neutral-300/80 shadow-[0_22px_56px_rgba(15,23,42,0.1)] bg-white transition-all duration-350 min-h-75 md:min-h-85 hover:shadow-[0_28px_64px_rgba(15,76,129,0.14)] hover:-translate-y-1 hover:scale-[1.01]">
        ...
        <div class="relative z-20">
          ...
          <h2 class="font-display text-[clamp(24px,3vw,36px)] font-bold tracking-[-0.8px] leading-[1.15] text-primary-900 my-2 relative z-10">Everything a voice agent needs</h2>
          <p class="text-[15px] text-neutral-600 leading-relaxed max-w-115 font-primary">Recordings, warm transfer, and telephony integrations — the full toolkit for production voice deployments.</p>

          <ul class="mt-4.5 flex flex-col gap-2.5 list-none p-0">
            <li v-for="(feat, i) in capabilityFeatures" :key="i"
                class="flex gap-4 items-start p-[14px_16px] bg-white border border-neutral-300/50 rounded-xl shadow-sm animate-[aaFeatIn_0.6s_ease_both] font-primary"
                :style="i > 0 ? { animationDelay: `${i * 0.07}s` } : {}">
              <span class="shrink-0 w-8 h-8 rounded-full flex items-center justify-center text-sm bg-neutral-100 text-primary-900">
                <i :class="feat.icon"></i>
              </span>
              <div>
          ...
          <p class="text-left text-sm text-neutral-500 mt-4 mb-0 font-primary">
            Looking for text and chat automation? See our <a href="chatbot.html" class="text-secondary-600 font-semibold hover:underline">Chatbot Agent</a>.
          </p>
        </div>
      </div>
    </section>
